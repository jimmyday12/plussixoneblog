...
Given this constrain, and the fact that I am about to leave the country for 2 weeks, there won't be any content at least over these first few rounds from me. When I get back, I'm going to be busy trying to find a good soure of data so that I don't have to manually create it again. (I have an exicting project that might solve this - more on that later). 

### AFLM
As per last year, I'll be running my ELO model and publishing that week to week. Given the new sturcture of the site, that whole weekly process will be much less of a pain this year and so I can focus on adding some interesting content each week. I'd love for any feedback from those who follow the blog about what is interesting for these weekly posts. Leave a comment below.

Outside of that, I'll try to get a few more smaller but interesting insights up. It's what I like doing so hopefully you'll see a bit more of that this year.
