...
```
# Data Aquisition
At this stage, I have our Betafair data which gives us match results and the Betfair odds. Unfortunately a lot of those odds are missing but for now I'm going to use all games. 
