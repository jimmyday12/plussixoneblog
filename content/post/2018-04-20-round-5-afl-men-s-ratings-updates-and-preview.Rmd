...
Ratings wise, there is now a pretty linear progression from 1st down to 9th, with maybe two groupings of top 4 (Richmond, Sydney, GWS, Adelaide) and 5th-9th (Geelong, West Coast, Port Adeliade, Hawthorn, Collingwood). These top 9 are, as expected, also finishing making finals in most simulations. All have >60% chance of reaching September.  
...
There is another drop to the Dogs, Saints and Dockers group before we have a decent step back to our celler dwellers in Brisbane, Gold Coast and Carlton. All of those teams would have to launch a pretty epic turnaround to make it even from this early stage you'd think.
...
## Other business
### Squiggle
I encourage you all to follow the Sqiggle on [Twitter](https://twitter.com/SquiggleAFL/) and at the [website](sqiggle.com.au). It collates tips from a range of different models. Max is putting a lot of great work in this year and the list of models is growing weekly! 
